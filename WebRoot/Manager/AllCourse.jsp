    ...
    <body>
        ...
        <div id="navi">                        
            <ul id="menu">
			 ...
			 <li><a href="ToAllCourse" class="choosed_on"></a></li>
		  ...
		  iconCls:'icon-save',
		    ...
		    columns:[[
		        {field:'courseId',checkbox:true},
		         ...
		         {field:'submitStartTime',title:'考试开始时间',width:100,sortable:true,editor:{
		        	  type:'validatebox',
		        	  options:{required:true}
		         }},
		         {field:'submitEndTime',title:'考试结束时间',width:100,sortable:true,editor:{
		        	  type:'validatebox',
		        	  options:{required:true}
		         }},
